...
cd "/node1/liuxy/MediCell/pbmc/TWAS/output/TWAS_2/"
declare -A celltypes=(
    ["pbmc"]="CD4T CD8T NK B Mono DC"
)
declare -A tissue_paths=(
    ["pbmc_db"]="/node1/liuxy/MediCell/pbmc/TWAS/usefile/db_2/"
    ["pbmc_cov"]="/node1/liuxy/MediCell/pbmc/TWAS/usefile/cov_6/"
)
disease_name="SLE"
gwas_files=/node1/liuxy/MediCell/pbmc/TWAS/usefile/bentham_2015_26502338_sle_processed_beta.tsv
output_base="/node1/liuxy/MediCell/pbmc/TWAS/output/TWAS_2/"
